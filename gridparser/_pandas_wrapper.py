...
class Core(object):
    ...
    """
    # NOTE: It is written under the assumption that there exists
    # attributes:
    # self.frame,
    # self.n_atoms,
    # self.copy
    ...
    def _is_physical(self, columns):
        ...
        is_orbital = {'x', 'y', 'z', 'value'} <= columns
        return (is_orbital)
    ...
    def replace(self,
        ...
        * This method has *a lot* of options. You are encouraged to experiment
        ...
        """
        if inplace:
            self.frame.replace(to_replace=to_replace,
                               value=value,
                               inplace=inplace,
                               limit=limit,
                               regex=regex,
        ...
        if drop == True:
            ...
            if not self._is_physical(set(self.columns) - set(dropped_columns)):
                raise PhysicalMeaningError(
                    ...
                    be a physical meaningful description of a molecule.')
