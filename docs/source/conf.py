...
# -*- coding: utf-8 -*-
#
# gridparser documentation build configuration file, created by
...
htmlhelp_basename = u'gridparserdoc'
...
latex_documents = [
  (master_doc, u'gridparser.tex', u'gridparser Documentation',
...
man_pages = [
    (master_doc, u'gridparser', u'gridparser Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, u'gridparser', u'gridparser Documentation',
   author, u'gridparser', u'One line description of project.',
   u'Miscellaneous'),
]
